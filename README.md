...
Configure SITE_URL com o domínio definitivo.
Use uma senha administrativa forte e exclusiva.
Ative HTTPS antes de definir NODE_ENV=production.
Configure backups de data/ e uploads/.
Cadastre o domínio no Google Search Console.
Envie https://seudominio.com.br/sitemap.xml ao Search Console.
Mantenha nome, telefone e endereço iguais no site e no Perfil da Empresa no Google.
Licença e uso
